...
阶段 A--J 已按各自卡口完成，其中 H--J 已通过项目负责人人工验收。阶段 K、L 候选版本的正式自动验收已通过，K/L 尚未进行的人工检查已按负责人批示并入最终发布算例验收，不视为追认通过，也不再阻塞 M--O 连续开发。阶段 M、N 已通过正式自动验收；阶段 O0--O5 已完成，正在准备 O6 全新构建和发布候选集中验收。当前能力边界见 [`docs/known-limitations.md`](docs/known-limitations.md)，候选说明见 [`docs/release-notes-0.1.0-rc1.md`](docs/release-notes-0.1.0-rc1.md)，许可状态见 [`LICENSE.md`](LICENSE.md)。
