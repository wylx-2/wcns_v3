...
状态：**2026-09-11 项目负责人已人工核验通过候选 `v1.1.0-t-candidate.1`，批准合入
`release/v1.1.0` 并进入阶段 U；批准记录标签为 `v1.1.0-t-approved.1`。**
...
项目负责人于 2026-09-11 完成人工核验，接受解析 Roe 逆矩阵与缓存复杂度、不实施伪通信
重叠/归约合并的取舍、8-rank strong 54.1% 与 weak 41.9% 的已知限制，以及 root 分块 I/O
接口，明确批准候选合入并进入阶段 U。该批准只结束 T；U 的发布矩阵、RC 和主干前人工卡口
仍必须独立完成。
